...
DEFAULT_SMILES_SDF_NAME = "out/target_prediction_smiles_converted.sdf"
...
DEFAULT_UNIPROT_DATABASE__CHEMBL_FILE_NAME = (
    BASE_PATH + "/" + "db/uniprot_database_ChEMBL.csv"
)
...
ENCODING = "utf-8"  # encoding of read files
...
FINGERPRINT_CMD = {  # Oh my god don't ever touch that unless you know what you're doing.
    "ECFP4": [
        ...
        "-m ExtendedConnectivityBits -n 2",
    ],
    "ECFP6": [
        "ExtendedConnectivityFingerprints.pl",
        "-m ExtendedConnectivityBits -n 3",
    ],
...
AVAILABLE_FILE_FORMAT = [DEFAULT_OUTPUT_FORMAT, CSV_FILE_FORMAT]

SD_MOL_DELIMITER = "\n$$$$\n"  # SDfiles molecule delimiter
DEFAULT_TC = object()  # Sentry for mem address checking
DEFAULT_OUTPUT = object()  # Sentry for mem address checking

FP_AVAILABLE = (
    FINGERPRINT_CMD.keys()
)  # Will hold the list of available fingerprint. Used while checking arguments.
